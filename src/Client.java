...
public class Client {
    public static void main(String[] args) {
        ...
        Supervisor chairOfMathDepartment = new Supervisor("Dr. John", "Chair of Math");
        Supervisor chairOfComputerScienceDepartment = new Supervisor("Dr. Ian", "Chair of Computer Science");
